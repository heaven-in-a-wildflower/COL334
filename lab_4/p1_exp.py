        ...
        for DELAY in delay_list:
            for FAST_RECOVERY in [0, 1]:
                for i in range(0, NUM_ITERATIONS):
                    ...
                    h1.cmd(f"python3 p1_server.py {SERVER_IP} {SERVER_PORT} {FAST_RECOVERY} > server_output.log 2>&1 &")
                    print("Running Client..")
                    result = h2.cmd(f"python3 p1_client.py {SERVER_IP} {SERVER_PORT} > client_output.log 2>&1")
